...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "not_detected": "{vt} verification was performed, but no clear match was found among currently executable patterns.",
    ...
    "ko": {
        ...
        "not_detected": "{vt} 검증을 수행했으나, 현재 실행 가능한 패턴에서는 뚜렷한 일치가 관찰되지 않았습니다.",
        "evidence_for": "관련 근거",
